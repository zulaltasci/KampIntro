...
namespace MernisServiceReference
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceReference.KPSPublicSoap>, MernisServiceReference.KPSPublicSoap
    {
        ...
        public System.Threading.Tasks.Task<MernisServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long v, string v1, string v2, MernisServiceReference.TCKimlikNoDogrulaRequest request)
        {
        ...
        internal bool TCKimlikNoDogrula(string nationalId, string v1, string v2, int year)
        {
        ...
        internal object TCKimlikNoDogrulaAsync(int v1, string v2, string v3, long v4)
        {
            throw new NotImplementedException();
        }
